#' ---
#' title: "Check UKB genetic data for men (candidate SNPs)"
...
pvar1 = NewPvar(paste0(data_QC2, '02_SNP_02_UKB_TC_GLGC_men.pvar'))
pgen = NewPgen(paste0(data_QC2,'02_SNP_02_UKB_TC_GLGC_men.pgen'), pvar=pvar1)
pvar = fread(paste0(data_QC2,'02_SNP_02_UKB_TC_GLGC_men.pvar'))
psam = fread(paste0(data_QC2,'02_SNP_02_UKB_TC_GLGC_men.psam'))
...
filt = psam$IID %in% myTab7[sex==1,ID] & psam$SEX==1
table(filt)
psam = psam[filt,]
...
#' # Save data ####
#' ***
save(pvar, psam, geno_mat, file = paste0(data_QC,"02_SNP_04_UKB_TC_GLGC_men_merged.RData"))
save(LDTab, file = paste0("../results/02_SNP_04_LD_men.RData"))
