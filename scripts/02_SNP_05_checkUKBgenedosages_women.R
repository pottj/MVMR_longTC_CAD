#' ---
#' title: "Check UKB genetic data for women (candidate SNPs)"
...
pvar1 = NewPvar(paste0(data_QC2, '02_SNP_03_UKB_TC_GLGC_women.pvar'))
pgen = NewPgen(paste0(data_QC2,'02_SNP_03_UKB_TC_GLGC_women.pgen'), pvar=pvar1)
pvar = fread(paste0(data_QC2,'02_SNP_03_UKB_TC_GLGC_women.pvar'))
psam = fread(paste0(data_QC2,'02_SNP_03_UKB_TC_GLGC_women.psam'))
...
filt = psam$IID %in% myTab7[sex==0,ID] & psam$SEX==2
table(filt)
psam = psam[filt,]
geno_mat = geno_mat[filt,]
...
#' # Save data ####
#' ***
save(pvar, psam, geno_mat, file = paste0(data_QC,"02_SNP_05_UKB_TC_GLGC_women_merged.RData"))
save(LDTab, file = paste0("../results/02_SNP_05_LD_women.RData"))
