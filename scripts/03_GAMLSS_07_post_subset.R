#' ---
#' title: "Get association of SNPs on TC (post-menopausal women - subset)"
...
save(myAssocs_X,file=paste0("../results/03_GAMLSS_07_post_subset.RData"))
