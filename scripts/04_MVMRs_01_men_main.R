...
#' ## Exposure
load("../results/03_GAMLSS_01_men_main.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/04_MVMRInput_men_main.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_01_men_main.RData"))
