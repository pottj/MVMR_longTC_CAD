#' ---
#' title: "MVMR - post-menopausal women - main"
...
#' ## Exposure
load("../results/03_GAMLSS_03_post_main.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/04_MVMRInput_post_main.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_03_post_main.RData"))
