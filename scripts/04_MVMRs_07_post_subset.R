#' ---
#' title: "MVMR - post-menopausal women - subset"
...
#' ## Exposure
load("../results/03_GAMLSS_07_post_subset.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/04_MVMRInput_post_subset.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_07_post_subset.RData"))
