#' ---
#' title: "MVMR - pre-menopausal women - subset"
...
#' ## Exposure
load("../results/03_GAMLSS_08_pre_subset.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/04_MVMRInput_pre_subset.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_08_pre_subset.RData"))
