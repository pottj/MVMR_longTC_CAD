...
#' ## Exposure
load("../results/03_GAMLSS_10_women_coloc.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/04_MVMRInput_women_coloc.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_10_women_coloc.RData"))
