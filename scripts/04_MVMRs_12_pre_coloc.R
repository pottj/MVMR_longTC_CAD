#' ---
#' title: "MVMR - pre-menopausal women - coloc"
...
#' ## Exposure
load("../results/03_GAMLSS_12_pre_coloc.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/04_MVMRInput_pre_coloc.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_12_pre_coloc.RData"))
