...
#' ## Exposure
load("../results/03_GAMLSS_16_men_coloc_middleAged.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/04_MVMRInput_men_coloc_young.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_16_men_coloc_young.RData"))
