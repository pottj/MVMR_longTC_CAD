...
#' ## Exposure
load("../results/03_GAMLSS_17_men_coloc_old.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/04_MVMRInput_men_coloc_old.RData"))
...
save(MVMR_results,file = paste0("../results/04_MVMR_17_men_coloc_old.RData"))
