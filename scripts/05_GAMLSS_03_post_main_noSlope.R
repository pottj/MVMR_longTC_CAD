#' ---
#' title: "Get association of SNPs on TC (post-menopausal women - MAIN)"
...
save(myAssocs_X,file=paste0("../results/05_GAMLSS_03_post_main_noSlope.RData"))
