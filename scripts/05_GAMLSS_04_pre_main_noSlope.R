#' ---
#' title: "Get association of SNPs on TC (pre-menopausal women - MAIN)"
...
save(myAssocs_X,file=paste0("../results/05_GAMLSS_04_pre_main_noSlope.RData"))
