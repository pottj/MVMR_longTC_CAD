#' ---
#' title: "Get association of SNPs on TC (post-menopausal women - coloc)"
...
save(myAssocs_X,file=paste0("../results/05_GAMLSS_11_post_coloc_noSlope.RData"))
