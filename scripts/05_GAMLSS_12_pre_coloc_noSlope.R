#' ---
#' title: "Get association of SNPs on TC (pre-menopausal women - coloc)"
...
save(myAssocs_X,file=paste0("../results/05_GAMLSS_12_pre_coloc_noSlope.RData"))
