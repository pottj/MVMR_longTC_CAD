#' ---
#' title: "MVMR - post-menopausal women - main - noSlope"
...
#' ## Exposure
load("../results/05_GAMLSS_03_post_main_noSlope.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/06_MVMRInput_post_main_noSlope.RData"))
...
save(MVMR_results,file = paste0("../results/06_MVMR_03_post_main_noSlope.RData"))
