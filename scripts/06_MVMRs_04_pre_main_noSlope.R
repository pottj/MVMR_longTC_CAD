#' ---
#' title: "MVMR - pre-menopausal women - main - noSlope"
...
#' ## Exposure
load("../results/05_GAMLSS_04_pre_main_noSlope.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/06_MVMRInput_pre_main_noSlope.RData"))
...
save(MVMR_results,file = paste0("../results/06_MVMR_04_pre_main_noSlope.RData"))
