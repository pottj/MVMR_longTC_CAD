#' ---
#' title: "MVMR - post-menopausal women - subset - noSlope"
...
#' ## Exposure
load("../results/05_GAMLSS_07_post_subset_noSlope.RData")
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/06_MVMRInput_post_subset_noSlope.RData"))
...
save(MVMR_results,file = paste0("../results/06_MVMR_07_post_subset_noSlope.RData"))
