#' ---
#' title: "MVMR - women - coloc - noSlope"
...
#' ## Exposure
load("../results/05_GAMLSS_10_women_coloc_noSlope.RData")
...
myAssocs_Y_UKB = myAssocs_Y_UKB[SNP %in% myAssocs_Y_long$rsID & model == "women"]
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/06_MVMRInput_women_coloc_noSlope.RData"))
...
save(MVMR_results,file = paste0("../results/06_MVMR_10_women_coloc_noSlope.RData"))
