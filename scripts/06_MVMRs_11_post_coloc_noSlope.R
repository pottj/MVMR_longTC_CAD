#' ---
#' title: "MVMR - post-menopausal women - coloc - noSlope"
...
myAssocs_Y_UKB = myAssocs_Y_UKB[SNP %in% myAssocs_Y_long$rsID & model == "postmenopausal"]
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/06_MVMRInput_post_coloc_noSlope.RData"))
...
save(MVMR_results,file = paste0("../results/06_MVMR_11_post_coloc_noSlope.RData"))
