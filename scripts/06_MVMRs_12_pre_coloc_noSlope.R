#' ---
#' title: "MVMR - pre-menopausal women - coloc - noSlope"
...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/06_MVMRInput_pre_coloc_noSlope.RData"))
...
save(MVMR_results,file = paste0("../results/06_MVMR_12_pre_coloc_noSlope.RData"))
