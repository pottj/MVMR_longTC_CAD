...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/06_MVMRInput_men_coloc_noSlope_young.RData"))
...
dumTab3 = foreach(k = 1:length(myOutcomes))%do%{
  ...
  MVMR0 = MVMR_jp_POPS(data_exposure = myAssocs_X_long,
                       ...
                       getPlot = F,
                       corTab = LDTab,
                       corTab_threshold = 0.1,sampleSize_GX = mySampleSize*2,
...
save(MVMR_results,file = paste0("../results/06_MVMR_16_men_coloc_noSlope_young.RData"))
