...
save(myAssocs_X_long,myAssocs_Y_long, file = paste0("../temp/06_MVMRInput_men_coloc_noSlope_old.RData"))
...
save(MVMR_results,file = paste0("../results/06_MVMR_17_men_coloc_noSlope_old.RData"))
