...
#' # Introduction ####
#' ***
#' I want two Forest Plots here, comparing men and women in both models (with vs without interaction). I want all exposure types in one plot. Restrict to 
#' 
#' 1) Men and women (no age groups)
...
myMVMR4_results = myMVMR4_results[c(9,10)]
myMVMR6_results = list.files(path = "../results/",pattern = "06_MVMR")
myMVMR6_results = myMVMR6_results[c(9,10)]
myMVMR_results = c(myMVMR4_results,myMVMR6_results)
...
dummy[c(1,6,9)] = "white"
dummy[c(2,7,10)] = "steelblue"
dummy[c(3,11)] = "lightblue"
dummy[c(4,8,12)] = "firebrick2"
dummy[c(5,13)] = "#F6C6AD"
...
filename = paste0("../results/_figures/ForestPlots/1_AllSNPs_2sample_MenWomen.png")
...
filename = paste0("../results/_figures/ForestPlots/1_GWSNPs_2sample_MenWomen.png")
png(filename = filename,width = 1800, height = 1000, res=200)
plot(p2)
dev.off()
