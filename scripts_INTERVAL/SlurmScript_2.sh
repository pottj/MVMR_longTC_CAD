...
R CMD BATCH --vanilla 03_ExtractSNPinfo_trajGWAS.R 03_ExtractSNPinfo_trajGWAS.R.out
cp Rplots.pdf 03_ExtractSNPinfo_trajGWAS_Rplots.pdf
rm Rplots.pdf
R CMD BATCH --vanilla 04_GAMLSS.R 04_GAMLSS.R.out
