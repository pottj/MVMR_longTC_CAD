...
R CMD BATCH --vanilla ../scripts/01_Prep_01_checkUKB.R ../scripts/01_Prep_01_checkUKB.R.out
cp Rplots.pdf 01_Prep_01_Rplots.pdf
rm Rplots.pdf

R CMD BATCH --vanilla ../scripts/01_Prep_02_checkUKB_menopause.R ../scripts/01_Prep_02_checkUKB_menopause.R.out
