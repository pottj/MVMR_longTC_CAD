...
R CMD BATCH --vanilla ../scripts/01_Prep_11_Plots_all.R ../scripts/01_Prep_11_Plots_all.R.out
cp Rplots.pdf 01_Prep_11_Rplots.pdf
rm Rplots.pdf

R CMD BATCH --vanilla ../scripts/01_Prep_12_Plots_subset.R ../scripts/01_Prep_12_Plots_subset.R.out
cp Rplots.pdf 01_Prep_12_Rplots.pdf
rm Rplots.pdf
